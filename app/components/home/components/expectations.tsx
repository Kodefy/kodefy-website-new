...
export function Expectations({ locale }: { locale: Locale }) {
  ...
  return (
    <section aria-labelledby="expectations-heading" className="relative overflow-hidden bg-white text-black">
      <div aria-hidden="true" className="absolute inset-y-0 left-0 hidden w-1/2 bg-zinc-100 lg:block" />
